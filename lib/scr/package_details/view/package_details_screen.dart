import 'package:barid/scr/package_details/view/package_details_view_model.dart';
import 'package:barid/scr/package_details/view/widgets/package_details_body.dart';
...
class PackageDetailsScreen extends StatefulWidget {
  ...
  const PackageDetailsScreen({super.key, required this.orderDetails});
  @override
  State<PackageDetailsScreen> createState() => _PackageDetailsScreenState();
}

class _PackageDetailsScreenState extends State<PackageDetailsScreen> {
  final viewModel = sl<PackageDetailsViewModel>();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: PreferredSize(
        ...
        child: CustomAppBar(
          model: CustomAppBarModel(
            title: AppLocalizations.of(context)!.translate('package_details'),
            showBackButton: true,
            backOnTap: () {
              context.pop();
            },
      ...
      body: SingleChildScrollView(
        ...
        child: PackageDetailsBody(viewModel: viewModel),
      ),
      bottomNavigationBar: Padding(
        ...
        child: AppButton(
          ...
          onPressed: ()=>viewModel.moveToPaymentScreen(context, orderDetails: widget.orderDetails),
        ),
      ),
    );
  }
